...
export default function DriverLoginPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(getApiUrl('/api/driver/login'), {
                method: 'POST',
                headers: {
            ...
            // Store the token and redirect directly (no email verification required for drivers)
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <Card className="w-full max-w-md">
                <CardHeader className="text-center">
                    ...
                    <CardDescription>
                        Sign in to your driver account to start delivering
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    {error && (
